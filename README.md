...
`worktips_utils/WorktipsCoreCpp*` are produced by transpiling Worktips core C++ code to JS via Emscripten (See *Building WorktipsCoreCpp*). A Module instance is managed by `worktips_utils/WorktipsCoreBridge.js`.
